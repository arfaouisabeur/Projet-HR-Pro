    ...
    public void openStatistiques() {
        try {
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(
                    getClass().getResource("/rh/EventStatsView.fxml"));
            ...
            ex.printStackTrace();
            showError("Impossible d'ouvrir les statistiques");
        }
    }

    @FXML
    public void goCalendrier() {
        try {
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(
                    getClass().getResource("/rh/CalendrierView.fxml"));
            javafx.scene.Parent root = loader.load();
            javafx.stage.Stage stage = new javafx.stage.Stage();
            stage.setTitle("Calendrier des jours fériés");
            stage.setScene(new javafx.scene.Scene(root, 900, 680));
            stage.setMinWidth(750);
            stage.setMinHeight(550);
            stage.initModality(javafx.stage.Modality.APPLICATION_MODAL);
