...
public class EvenementService implements IEvenementService {
    ...
    public void addEntity(Evenement e) throws SQLException {
        String sql = "INSERT INTO evenement (titre, date_debut, date_fin, lieu, description, image_url, rh_id) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public void updateEntity(Evenement e) throws SQLException {
        String sql = "UPDATE evenement SET titre=?, date_debut=?, date_fin=?, lieu=?, description=?, image_url=?, rh_id=? " +
                "WHERE id=?";
