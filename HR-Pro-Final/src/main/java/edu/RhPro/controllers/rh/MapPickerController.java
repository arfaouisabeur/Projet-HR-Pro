    ...
    private void loadStaticMap() {
        ...
        Task<Image> mapTask = new Task<>() {
            ...
            protected Image call() throws Exception {
                return mapService.loadStaticMap(selectedLat, selectedLon, 600, 300, 15);
            }
        };
        ...
        mapTask.setOnSucceeded(e -> {
            ...
            if (mapImage != null && !mapImage.isError()) {
                ...
                updateStatus("Carte non disponible - utilisez le lien interactif");
                openInBrowserLink.setVisible(true);
                openInBrowserLink.setManaged(true);
            }
        });
        ...
        mapTask.setOnFailed(e -> {
            showLoading(false);
            updateStatus("Erreur de chargement - utilisez le lien ci-dessous");
            openInBrowserLink.setVisible(true);
            openInBrowserLink.setManaged(true);
            e.getSource().getException().printStackTrace();
        });
